...
This is a simple docker image that updates PorkBun DNS(s) with your current IP address. Optionally you can set static IP addresses for your DNS records.

The code is located on [GitHub](https://github.com/jjsuperpower/Docker-Containers/tree/main/porkbun-dns). Issues can be reported there. Please feel free to contribute.
...
| `domains_file` | Path to domains file | `/data/domains.txt` |
